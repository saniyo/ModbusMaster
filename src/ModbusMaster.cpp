...
uint8_t ModbusMaster::ModbusMasterTransaction(uint8_t u8MBFunction)
{
  ...
  case ku8MBFileRequest:
    ...
    case INIT_REQ:
      //Serial.println("INIT_REQ");
      u8ModbusADU[u8ModbusADUSize++] = INIT_REQ;
      u8ModbusADU[u8ModbusADUSize++] = 0x0F;
      u8ModbusADU[u8ModbusADUSize++] = ku8MBFileRequestType;
      u8ModbusADU[u8ModbusADUSize++] = 0x30;
      u8ModbusADU[u8ModbusADUSize++] = highByte(highWord(ku32MBFileRequestHeader));
      u8ModbusADU[u8ModbusADUSize++] = lowByte(highWord(ku32MBFileRequestHeader));
      u8ModbusADU[u8ModbusADUSize++] = highByte(lowWord(ku32MBFileRequestHeader));
      u8ModbusADU[u8ModbusADUSize++] = lowByte(lowWord(ku32MBFileRequestHeader));
      u8ModbusADU[u8ModbusADUSize++] = highByte(highWord(_u32FileRequestStartTime));
      u8ModbusADU[u8ModbusADUSize++] = lowByte(highWord(_u32FileRequestStartTime));
      u8ModbusADU[u8ModbusADUSize++] = highByte(lowWord(_u32FileRequestStartTime));
      u8ModbusADU[u8ModbusADUSize++] = lowByte(lowWord(_u32FileRequestStartTime));
      u8ModbusADU[u8ModbusADUSize++] = highByte(highWord(_u32FileRequestEndTime));
      u8ModbusADU[u8ModbusADUSize++] = lowByte(highWord(_u32FileRequestEndTime));
      u8ModbusADU[u8ModbusADUSize++] = highByte(lowWord(_u32FileRequestEndTime));
      u8ModbusADU[u8ModbusADUSize++] = lowByte(lowWord(_u32FileRequestEndTime));
      u8ModbusADU[u8ModbusADUSize++] = twoZeros;
      break;

    case FRAME_REQ:
      //Serial.println("FRAME_REQ");
      u8ModbusADU[u8ModbusADUSize++] = FRAME_REQ;
      u8ModbusADU[u8ModbusADUSize++] = 0x03;
      u8ModbusADU[u8ModbusADUSize++] = ku8MBFileRequestType;
      u8ModbusADU[u8ModbusADUSize++] = highByte(_u8FRFrameNum);
      u8ModbusADU[u8ModbusADUSize++] = lowByte(_u8FRFrameNum);
      break;

    case FINISH_REQ:
      //Serial.println("FINISH_REQ");
      u8ModbusADU[u8ModbusADUSize++] = FINISH_REQ;
